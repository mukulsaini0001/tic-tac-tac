...
tk=Tk()
tk.title("TIC TSC TOE MULTIPLAYER")
...
def checkforwin():
    ...
    elif(button1['text']== "O"and button2['text'] == "O" and button3['text'] == 'X' or
        button4['text']== "O" and button5['text'] == "O" and button6['text'] == 'X' or
        button7['text']== "O"and button8['text'] == "O" and button9['text'] == 'X' or
        button1['text']== "O"and button5['text'] == "O" and button9['text'] == 'X' or
        button3['text']== "O"and button5['text'] == "O" and button7['text'] == 'X' or
        button1['text']== "O"and button2['text'] == "O" and button3['text'] == 'X' or
        button1['text']== "O"and button2['text'] == "O" and button3['text'] == 'X' or
        button2['text']== "O"and button5['text'] == "O" and button8['text'] == 'X' or
        button7['text']== "O"and button6['text'] == "O" and button9['text'] == 'X' ):
        disableButton()
